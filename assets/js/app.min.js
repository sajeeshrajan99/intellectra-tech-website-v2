...
// Page appearance (initial animation)
function pageAppearance() {
  ...
  gsap.set(fadeInItems, { opacity: 0, y: 50 });
  gsap.to(fadeInItems, {
    duration: 0.9,
    ease: "power2.out",
    opacity: 1,
...
// Run immediately (no preloader)
document.addEventListener("DOMContentLoaded", pageAppearance);
